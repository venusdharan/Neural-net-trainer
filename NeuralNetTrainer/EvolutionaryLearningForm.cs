...
{
    public partial class EvolutionaryLearningForm : Form
    {
        ...
        public ActivationNetwork networkEV;
        public EvolutionaryLearning teacherEV;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (r != System.Windows.Forms.DialogResult.Cancel)
            {
                if (File.Exists(saveFileDialog1.FileName))
                {
                    ...
                    {
                        networkEV.Save(saveFileDialog1.FileName);
        ...
        private void loadfile(object sender, EventArgs e)
        {
            ...
            if (r != System.Windows.Forms.DialogResult.Cancel)
            {
                try
                {
                    ...
                    networkEV = n as ActivationNetwork;
                }
                catch (Exception eg)
                {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            //        double[] output = networkEV.Compute(input);
        ...
        private void EvolutionaryLearningForm_Load(object sender, EventArgs e)
        {
            // set your pane
            myPane = zedGraphControl1.GraphPane;
